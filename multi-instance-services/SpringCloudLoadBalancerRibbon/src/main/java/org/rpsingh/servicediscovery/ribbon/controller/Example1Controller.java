package org.rpsingh.servicediscovery.ribbon.controller;
...
public class Example1Controller {
    ...
    public String showFirstService() {
        ...
        String html = String.format("<h2>Instances for Service Id: %s</h2>" + serviceId);
 
        for (ServiceInstance serviceInstance : instances) {
            html += String.format("<h3>Instance : %s</h3>",serviceInstance.getUri());
        }
